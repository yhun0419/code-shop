...
<template>
  ...
  <main id="top">
    ...
    <section id="visit" class="booking"><div class="container booking-wrap"><div><div class="eyebrow">MAKE A RESERVATION</div><h2>留一张桌子，等你赴约。</h2></div><a class="button light" href="tel:021-55668899">立即预订 · 021 5566 8899</a></div></section>
  </main>
