...
<template>
  ...
  <main id="top">
    <section class="hero"><div class="hero-content"><div class="eyebrow">SEASONAL CHINESE KITCHEN</div><h1>把山海，端上餐桌</h1><p>精选当季山海风物，以细腻火候呈现一席有温度、有记忆点的现代中式料理。</p><a class="button" href="#menu">探索今日菜单 <span>→</span></a></div><div class="hero-info"><div><strong>营业时间</strong>11:30–14:00 · 17:30–22:00</div><div><strong>上海 · 徐汇</strong>衡山路 188 号</div></div></section>
    ...
    <section id="special" class="feature"><div class="container feature-grid"><div class="feature-photo" role="img" aria-label="精致菜肴"></div><div class="feature-content"><span class="tag">CHEF'S SELECTION · 08</span><h2>慢炖 12 小时的<br>黑蒜牛肋</h2><p class="special-desc">每日限量供应，以慢火锁住肉汁与酱香，是主厨最想让你先尝的一道招牌菜。</p><p>选用谷饲牛小排，佐以发酵黑蒜、绍兴黄酒与时蔬清汤。时间让丰腴与醇厚在舌尖相遇。</p><div class="dish-note"><b>¥ 168</b><span>推荐搭配：福建岩茶 / 深色艾尔</span></div></div></div></section>
